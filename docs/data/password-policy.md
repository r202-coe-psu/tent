...
| --- | --- | --- | --- | --- |
| 2026-07-01 | 1.0 | กำหนดมาตรฐานความยาว 10 ตัวอักษร, พิมพ์ใหญ่, พิมพ์เล็ก, ตัวเลข และอักขระพิเศษ | [CR-026](../changes/CR-026-user-management-architecture.md) | Soravit Sukkarn |

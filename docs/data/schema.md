...
> **schema_v 1:** สร้างเฉพาะศูนย์ที่ต้องการใช้สัดส่วนทรัพยากรต่างจาก Master Profile ส่วนกลาง (ตาม [CR-006](file:///home/ne/projects/tent/docs/changes/CR-006-sop-profile-master-override.md))
...
| `ratios` | {str: num} | req | key ตายตัวที่ต้องการ override |
| `version` | int | req | — |
...
> **schema_v 2:** ย้ายมาอยู่ catalog DB, ตัด `shelter_code` ออกเพื่อใช้เป็น Master Profile กลาง
...
| `catalog` | item: category · recipe: active · sop_profile: active | — |

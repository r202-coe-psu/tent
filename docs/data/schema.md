...
> **schema_v 2** — เพิ่ม `purchase` เป็นหนึ่งใน reason ของ `stock_ledger` สำหรับการจัดซื้อจัดจ้าง (T-11)
...
| `reason` | enum(`receive`,`distribute`,`requisition`,`adjust`,`transfer_out`,`transfer_in`,`donation`,`purchase`) | req | — |

...
Kitchen Lead สร้าง Meal Plan ต่อมื้อต่อศูนย์ โดยระบบคำนวณวัตถุดิบจาก occupancy × SOP Ratio (FR-46)
...
**Description:** Volunteer Coordinator รับสมัครอาสา จับคู่ทักษะกับงาน และจัดกะ Realizes ความต้องการอาสาจาก Resource Calculation (FR-46)

...
- **Shelter Manager** ต้องติดตามการเข้า-ออกเชิงความปลอดภัยและดูแลคน+สัตว์ในศูนย์ — Security Officer ไม่ใช่ role แยก (CR-002)
...
**Description:** Security Officer ติดตามความปลอดภัยเข้า-ออกเชิง incident (ต่อยอด movement ของ baseline FR-12/13) และ **Shelter Manager** ส่งต่อ (referral) เมื่อศูนย์เต็ม/อาหารขาด/ผู้ป่วยฉุกเฉิน — referral owner = `shelter_manager` เดิม, ไม่เพิ่ม role ใหม่ (FD-13)

...
PRD ฉบับนี้กำหนด scope/FR/NFR ของ **Phase R3 (ก.ค.–ส.ค. 2026, Operations Gate 22 ส.ค.)** — phase ที่เปิด module operations หลังบ้านพร้อมกันหลาย track ผู้อ่านคือ PM/SA, PO, ทีมที่เกี่ยวข้อง (จับทีม **รอตัดสินใจ — K-13**) และ QA/Release Owner

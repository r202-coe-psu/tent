...
| **Team B** | Household/People + Family Search + Shelter Reports | พีค — สักก์ธนัชญ์ ประดิษฐอุกฤษฎ์ | โฮป — พัฒนชัย พันธุ์เกตุ | ปิ๊ก — สิรวิชญ์ น้อยผา | R2-R4 |
...
| Shelter Reports | Module E | Team B | R3 | ผูก People (refs) / Referral escalate |
...
- R2: ทีมที่ยังไม่มี module หลัก (Kitchen/Volunteer/Shelter Reports) → มอบ groundwork จริง (schema, prototype, เก็บค่า SOP) อย่า idle.

...
affects:
  ...
  - docs/task-breakdown/05-D-kitchen.md — T-25 (meal plan อ่านจากครัว ไม่ใช่ sop_profile)
  - docs/task-breakdown/07-B-sop.md — T-30/T-31/T-32 (อาสา = key ใน sop_profile)
...
- `docs/task-breakdown/05-D-kitchen.md` — T-25 description
- `docs/task-breakdown/07-B-sop.md` — T-30/T-31/T-32

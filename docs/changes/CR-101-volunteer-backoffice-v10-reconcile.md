---
id: CR-101
title: Volunteer Backoffice V10 — back-office path, CouchDB-native time-bound access, job CRUD in back-office, Couch→Mongo public sync + UI V10 schema deltas (renumbered from CR-094)
status: superseded
superseded_by: CR-104
superseded_date: 2026-08-31
note: รวมเนื้อหาเข้าสู่ CR-104-volunteer-backoffice-and-user-management-v10.md ฉบับสมบูรณ์แล้ว (renumbered จาก CR-094 เดิมเพื่อไม่ให้ชนกับ stock threshold override)
date: 2026-08-26
...
# CR-101 — Volunteer Backoffice V10 (ต่อยอด/แก้ CR-092, renumbered จาก CR-094)

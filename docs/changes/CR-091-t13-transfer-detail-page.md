...
- **FR-03** — แสดงรายการ item ทั้งหมดของคำร้อง พร้อม field ที่มีอยู่แล้ว ณ วันที่หน้านี้ ship (`lot`,
  `source_lot`, `driver_name`, `vehicle_plate` — field ไหนยังไม่มีในโค้ดเพราะ CR-089 ยังไม่ landed ให้
...
- [ ] เปิดหน้ารายละเอียดของคำร้องที่สร้างก่อน CR-089/CR-090 landed (ไม่มี `lot`/`driver_name` ฯลฯ) ไม่ error
...
- แยกออกจาก [CR-089](CR-089-t13-transfer-lot-driver-dispute.md) เพราะหน้านี้เป็น UI ล้วน ไม่เปลี่ยน

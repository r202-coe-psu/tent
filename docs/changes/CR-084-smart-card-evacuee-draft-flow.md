...
* **Step 3 (Household & Address):** **Autofill ที่อยู่เดิมตามบัตรประชาชนลงฟอร์มอัตโนมัติไปก่อน** (รวมถึง **รหัสไปรษณีย์ `postal_code` ที่ถูกแมปอัตโนมัติจากพจนานุกรมตำบล/อำเภอ/จังหวัดของระบบและบันทึกไว้ใน draft**) เจ้าหน้าที่สอบถามยืนยันกับผู้ประสบภัย และสามารถแก้ไขได้ทันที พร้อมทำ Family Matching

...
| รวมศูนย์การจัดการสิทธิ์ CouchDB Admin | ให้ Backend API (`/api/v1/users`) เป็นคอขวดเดียวที่ถือสิทธิ์ CouchDB Admin ในการสร้าง/ลบ/แก้ไข users ช่วยลดความเสี่ยง                        |
| รองรับ Authorization Scope            | การบังคับใช้กฎ Shelter Manager ไม่สามารถแก้ไข/ลบ SA หรือ Manager ด้วยกันเองได้ และทำได้แค่ในศูนย์ของตนเอง ต้องทำในฝั่ง Server ที่เชื่อถือได้ |

...
affects:
  ...
  - docs/data/schema.md §5.5 (ลบย่อหน้า mirror-write สองทางที่ค้างเก่า — CR-059 ยกเลิกไปแล้ว 2026-08-22)
...
- **FR-22** — `schema.md` §5.5 **ลบย่อหน้า mirror-write สองทาง** (`shipped` → mirror เข้า
  ...
  แต่ §5.5 ยังเขียนค้างไว้ ⇒ แทนที่ด้วยข้อความ refetch-on-interaction ตามที่ตัดสินใจจริง

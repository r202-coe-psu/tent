...
extends:
  ...
  - CR-140/CR-143 (ticket-list.svelte unified hub — เดิมมี tab "รอตรวจรับเข้าคลัง" เป็น mock
...
# CR-144: ขั้น "รอตรวจรับเข้าคลัง" จริงหลังบันทึกผลผลิตครัว
...
ปุ่ม "ยืนยันตรวจรับ" (คลิกเดียว ตามแพทเทิร์น CR-143) อยู่ในแถวของ ticket-list.svelte เอง เรียก
...
CR-143) และไม่ผูกกับการรับเข้าสต็อกอาหารปรุงสำเร็จ (`yield_items`/`stock_ledger reason=receive`

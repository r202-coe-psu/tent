...
# CR-085 — ระบบบริหารจัดการจิตอาสาฉบับสมบูรณ์ V10 (SmartShelter Volunteer Management System)

## สรุป (TL;DR)

- **เปลี่ยนอะไร:** แปลงข้อกำหนด `volunteer_flow.md` (V10) เป็น CR-085 ครอบคลุมสถาปัตยกรรมจิตอาสาแบบครบวงจร:
...
- **2026-08-24 — Proposed:** ถอดบทเรียนจาก UIv10 และแปลงเป็น CR-085 สำหรับเตรียมพร้อมจัดทำ Task implementation และ Handover สู่ทีมพัฒนา
...
> ตาม Change Management Policy (§6) ห้าม AI ตัดสินใจเคาะ approved หรือเลือกช่องทาง track เองโดยไม่มีคำสั่ง โปรดพิจารณาเคาะเลือกช่องทางติดตามงานสำหรับ CR-085 ดังนี้:
>
> 1. **Option A (แนะนำ):** ติดตามผ่านไฟล์ CR Markdown ในคลังโค้ด (`docs/changes/CR-085-volunteer-management-v10-flow.md` + อัปเดต `docs/changes/_index.md`)
> 2. **Option B:** ติดตามผ่าน Notion Projects Tasks (สร้าง Card CR-085 ในตาราง Notion)

...
**Definition of Done:**
- รับเข้า: เลือก item + จำนวน + source marker (donation / purchase / transfer-in / manual) → ledger entry ถูกสร้าง + on-hand เพิ่มทันที พร้อม audit (ใคร/เมื่อไร) — `purchase` เพิ่มโดย CR-031

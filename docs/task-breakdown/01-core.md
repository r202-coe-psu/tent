...
>
> - **T-01 🔄** — Role kernel (`$lib/auth/roles.ts`: SYSTEM_ADMIN, SHELTER_MANAGER, STAFF_CAPABILITIES, guard helpers) + auth store + route guards done; field-level permissions + full role-permission matrix ยังไม่ครบ DoD

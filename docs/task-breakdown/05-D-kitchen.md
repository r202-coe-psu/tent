...
- เลือกถังแก๊สจริงต่อแผนได้ (หลายถัง) เตือนถ้ายอดที่คำนวณเกินยอดคงเหลือของถังนั้น (CR-086)
...
- ถ้าแผนมีถังแก๊ส (T-25) ตัด `gas_ledger` พร้อมกันแบบ atomic — ถังไม่พอ **บล็อกทั้งใบ** (CR-086)
...
- บันทึก actual_yield (ผลผลิตที่ทำได้จริง, optional) ต่อมื้อ และสรุปเทียบ yield vs แผนได้ในหน้าสรุปบริการ (CR-085)

...
2. **ทีม B (พีค, โฮป, ปิ๊ก) — 35.0 MD / 10 Tasks**: 
   - ดูแลระบบลงทะเบียนผู้อพยพ [02-people.md](02-people.md), หน้าสืบค้นครอบครัว [11-famsearch.md](11-famsearch.md), และความปลอดภัยเข้าออก [08-E.md](08-E.md)
   - *จุดเด่น (Resident Lifecycle & Security)*: เป็นทีมที่คุมโดเมนด้าน "บุคคล" ตั้งแต่การลงทะเบียน สแกน QR เข้าออกศูนย์ และการเปิดให้สืบค้นชื่อ (Consent) การนำโมดูลเหล่านี้มาอยู่ด้วยกันช่วยตัดปัญหาการรอเชื่อม Schema ฐานข้อมูลกันได้อย่างสมบูรณ์ 100%
...
- **สมาชิก CoE และ AiE ปี 4** 
    ...
    - CoE เน เคยผ่านการเขียน react จากวิชา webdev

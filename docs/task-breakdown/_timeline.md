...
**Baseline (T-47..T-55)** รันขนานช่วง มิ.ย.–ก.ค. — ไม่อยู่บนเส้นวิกฤต stock chain แต่ **ต้องจบใน Foundation Gate (17 ก.ค.)** เพราะ flow หน้างาน (register→screen→check-in) เป็น precondition ของ occupancy data ที่ R3 ใช้; **T-54 offline sync = tech risk #1** เริ่มทันทีหลัง skeleton.
...
gantt
  ...
  T-54 offline sync (tech risk #1)    :crit, bl3, 2026-06-17, 12d
...
> **Baseline (T-47..55)** รันขนาน มิ.ย.–ก.ค. ต้องจบใน Foundation Gate; T-54 offline sync = tech risk #1.

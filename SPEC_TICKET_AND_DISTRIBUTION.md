...
> **สรุปภาพรวม (TL;DR):**  
> จัดการวงจรเบิกจ่ายพัสดุและอาหาร 4 ประเภท เชื่อมโยง **โรงครัว ➔ คลังสินค้า ➔ จุดแจกจ่ายหน้างาน** ผ่าน **4 หน้าจอเฉพาะทางตามประเภทที่เบิก (`/back-office/tickets/*`)** รองรับการตัดสต็อกคลังอัตโนมัติ การสแกน QR ตรวจสิทธิ์และเงื่อนไขพิเศษรายบุคคล (Default = 1 ชิ้น, ปรับจำนวนได้) พร้อมระบบกระทบยอด (Reconciliation) ปิดรอบการแจกจ่าย

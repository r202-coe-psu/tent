...
Invoke the `bmad-review-adversarial-general` skill and review the following implementation diff without assuming prior conversation context. Report only actionable findings, with file/line references, consequence, and a suggested fix. Check whether the implementation satisfies the approved intent and whether it introduces regressions.

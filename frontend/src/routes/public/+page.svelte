				...
				<Accordion.Root type="single" value="item-1">
					...
					>
						...
						<Accordion.Content class="pt-2 text-sm leading-relaxed text-muted-foreground">
							ท่านสามารถไปที่เมนู <strong>"สืบค้นญาติ"</strong> และใช้หมายเลขบัตรประชาชน 13 หลัก, ชื่อ-นามสกุล
							หรือหมายเลขหนังสือเดินทางในการค้นหา ระบบจะแสดงสถานะความปลอดภัยและศูนย์พักพิงที่ญาติของท่านพักอาศัยอยู่ปัจจุบัน

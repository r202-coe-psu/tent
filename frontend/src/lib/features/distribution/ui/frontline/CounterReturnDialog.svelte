				...
				<div class="flex flex-wrap items-center justify-end gap-3 border-t border-slate-100 pt-4">
					...
					<Button
						...
						disabled={returnMutation.isPending ||
							...
							!canReturnStock ||
							isCrossModeCollision}
						class="h-9 gap-2 rounded-xl border-emerald-600 bg-emerald-600 px-5 text-xs font-bold text-white shadow-xs transition-colors hover:bg-emerald-700 disabled:cursor-not-allowed"
					>

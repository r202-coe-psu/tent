...
// ---- MealServiceReceipt (append-only warehouse receipt decision, CR-129/CR-130) ----
...
export interface MealServiceReceipt extends BaseDoc {
	...
	// Optional for backward compat — docs written before CR-130 predate this
...
/** Reads a receipt's outcome, treating a pre-CR-130 doc (no `outcome` field) as 'confirmed'. */

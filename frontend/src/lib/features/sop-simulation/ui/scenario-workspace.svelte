<script lang="ts">
	...
	async function run(input: ScenarioInput) {
		try {
			...
			toast.error('รันสถานการณ์ไม่สำเร็จ ตรวจสอบข้อมูลและการเชื่อมต่อ');
		}
	}
	...
	async function save() {
		...
		try {
			...
			toast.error('บันทึกสถานการณ์ไม่สำเร็จ');
		}
	}
	...
	async function openScenario(id: string) {
		try {
			...
			toast.error('เปิดสถานการณ์ไม่สำเร็จ ตรวจสอบการเชื่อมต่อหรือข้อมูลที่บันทึก');
		}
	}
</script>

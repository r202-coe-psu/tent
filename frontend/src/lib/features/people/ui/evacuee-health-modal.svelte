				...
				<div class="space-y-5 p-4 sm:p-5">
					<section class="space-y-3" aria-labelledby="health-summary-heading">
						<div class="flex items-center justify-between border-b border-border pb-2">
							...
							{#if referral}
								<span
									class="inline-flex items-center gap-1.5 rounded-md border border-amber-300 bg-amber-50 px-2 py-1 text-2xs font-semibold text-amber-800 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-200"
								>
					...
					<section class="space-y-3" aria-labelledby="needs-heading">
						<div class="border-b border-border pb-2">
							...
							<p class="text-2xs text-muted-foreground">แสดงเฉพาะกลุ่มที่ศูนย์พักพิงรองรับ</p>
						</div>

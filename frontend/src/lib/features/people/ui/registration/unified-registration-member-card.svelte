...
<section id="unified-member-{index}" class={cardClass} aria-labelledby="member-card-title-{index}">
	...
	<Accordion.Root type="multiple" class="w-full">
		...
		<Accordion.Item value="vulnerable">
			<Accordion.Trigger class="hover:no-underline">
				<span class="flex items-center gap-2">
					<ShieldAlert class="size-4 text-primary" />
					<span class="text-sm font-semibold text-foreground">{t.vulnerableSection}</span>
				</span>
			</Accordion.Trigger>
			<Accordion.Content>
		...
		<Accordion.Item value="special-needs">
			<Accordion.Trigger class="hover:no-underline">
				<span class="flex items-center gap-2">
					<HeartPulse class="size-4 text-primary" />
					<span class="text-sm font-semibold text-foreground">{t.specialNeedsSection}</span>
				</span>
			</Accordion.Trigger>
			<Accordion.Content>

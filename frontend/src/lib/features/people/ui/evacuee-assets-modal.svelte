...
{#if show}
	...
	>
		<div
			class="w-full max-w-xl animate-in space-y-4 rounded-2xl border border-border bg-card p-6 shadow-xl duration-150 zoom-in-95 fade-in"
		>
			...
			<div class="max-h-[min(70vh,540px)] overflow-y-auto pr-1">

...
{#if show}
	...
	>
		<div
			class={embedded
				? 'flex w-full max-w-lg flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-sm'
				: 'flex max-h-[92vh] w-full max-w-lg flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-2xl'}
		>
			<!-- Modal Header -->
			...
			<div class={embedded ? 'p-4 sm:p-5' : 'flex-1 overflow-y-auto p-5 sm:p-6'}>
				<div
					bind:this={cardEl}

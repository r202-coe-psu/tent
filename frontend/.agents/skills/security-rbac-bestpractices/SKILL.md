...
- **EOC & Public APIs**: Never expose `medical`, `vulnerability`, or `national_id` fields to Public APIs or the EOC (Emergency Operation Center) sync endpoints. Redact these fields server-side before returning JSON.

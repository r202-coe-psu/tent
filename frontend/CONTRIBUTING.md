...
| 2. Seed / write staff data | `frontend/`                            | `pnpm seed` / `pnpm seed:staging` (or `pnpm seed:master` for lookups only; or normal staff UI writes) so CouchDB has docs to project |
